...
<body>
	쿠키 생성
	전체 적용하는 쿠키<br>
	<a href="<%=request.getContextPath()%>/10/viewCookie.jsp" target="_blank">전체 보이는 쿠키 이동</a>
	...
	%>
		...
		<%
			CookieBox cookiBox = new CookieBox(request);
			
			Cookie userCookie= cookiBox.createCookie("userCookie", "홍길동");
