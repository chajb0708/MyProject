...
<body>
	...
	<jsp:setProperty property="userEmail" name="loginInfo" value="master@nextit.or.kt"/>
	<pre>
	 	아이디 : ${loginInfo.userId }
	 	비번 : ${loginInfo.userPw }
	 	아이디 저장 유무 : ${loginInfo.userRemember =='Y' ? '아이디저장' : '아이디 저장 안함'}
	...
	<%
		...
		if ("Y".equals(userRemember)){
			...
			Cookie cRemember = CookieBox.createCookie("userRemember", request.getParameter("userRemember"));	
