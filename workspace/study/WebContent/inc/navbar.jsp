	...
	<div class="container">
		...
		<div id="navbar" class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li><a href="<%=request.getContextPath()%>/06/fileRead.jsp">file
						Read</a></li>
				...
				<li><a
					href="<%=request.getContextPath()%>/14/memberInsertForm.jsp">회원가입</a>
				</li>
				<%
					} else {
				%>
				<li><a href="<%=request.getContextPath()%>/11/logoutProc.jsp">
						${loginInfo.userName }님 로그아웃</a></li>
				<li><a
					href="<%=request.getContextPath()%>/14/memberListForm.jsp">회원관리</a>
				</li>
				<%
					}
				%>
