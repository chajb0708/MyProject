...
<body>
	...
	<div class="container">
		...
		<table class="table">
			<tbody>
				<tr>
					<td><a href="<c:url value="/14/memberListForm.jsp"/>">목록</a></td>
					...
					<a
						href="${updatePage }">수정</a></td>

					<td><a
						href="<%=request.getContextPath()%>/14/memberDeleteProc.jsp?memId=${result.memId}">삭제</a></td>
				</tr>
			</tbody>
		</table>
